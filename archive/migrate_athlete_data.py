"""
Migration script: move Valissa's session and wellbeing data
...
Run from your project root:
  ...
  python migrate_athlete_data.py
"""
...
COLLECTIONS     = ["sessions", "wellbeing"]  # collections to migrate
# ───────────────────────────────────────────────────────────────────────────
...
def migrate():
    ...
    print("\n✅ Migration complete.")
    print(f"Verify data at: athletes/{TO_ATHLETE_ID}/sessions and /wellbeing")
    print(f"Then manually delete: athletes/{FROM_ATHLETE_ID}/sessions and /wellbeing")
